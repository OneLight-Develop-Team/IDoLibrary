    ...
    def Light_Import_Fn(self):
        ...
        for lightName in Light_Json['LightData']:
            ...
            if lightNameData['Type'] == "pointLight":
                ...
                aiLight = mtoa.utils.createLocatorWithName("aiSkyDomeLight",lightNameData['Name'] ,asLight=True)
                cmds.rename(aiLight[1],lightName)
            elif lightNameData['Type'] == "aiAreaLight1":
                aiLight = mtoa.utils.createLocatorWithName("aiAreaLight",lightNameData['Name'] ,asLight=True)
                cmds.rename(aiLight[1],lightName)
